...
#from para_transformer.packages.submodopt.submodopt.submodopt import SubmodularOpt
import numpy as np
...
class SequenceGenerator(object):
	...
	def beam_search(self, initial_input, initial_state=None, top_k = 0, top_p = 0):
